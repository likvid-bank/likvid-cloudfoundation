...
1. Navigate to the "Platform Builder" of the ${md_sap_core_platform} workspace.
...
1. The application team has the workspace ${md_workspace_sap_core_platform} and project ${meshstack_project_sap_core_platform}.
