...
The scenario we are looking at: [M25 Platform Team](md_workspace_m25_platform_team) has already built
...
1. The Definition is created by the [M25 Platform Team](md_workspace_m25_platform_team) within their workspace: ${md_workspace_m25_platform_team}.
...
```bash
Workspace ${md_workspace_m25_online_banking}
...
Now that [M25 Platform Team](md_workspace_m25_platform_team) has their service published and application team may ordered the website hosting service: `${meshstack_project_m25_online_banking_app_spec_display_name}`
...
sources. This API key must be scoped to the repository ${md_workspace_m25_platform_team} (in which the Building Block definition lives).
