...
We automate validation and deployment of our cloud foundation IaC code on the GitHub repo [${data.github_repository.foundation_repo.full_name}](${data.github_repository.foundation_repo.html_url})
via GitHub Actions.
