...
terraform {
  source = "${get_repo_root()}//kit/azure/buildingblock-backplane/budget-alert"
}
...
inputs = {
  ...
  deployment_scope        = "/providers/Microsoft.Management/managementGroups/likvid-foundation"
  ...
  generate_local_files    = "1" # Change it to '1' in order to have the outputs as file.
}
