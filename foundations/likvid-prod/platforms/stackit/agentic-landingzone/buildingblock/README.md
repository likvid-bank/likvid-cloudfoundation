...
[`modules/stackit`](https://github.com/meshcloud/meshstack-hub/tree/b70efaad7de7fccf2dcb513d94db6308295261a0/modules/stackit) project integration to provision the STACKIT Project
...
offering: it registers [`modules/stackit/network-area`](https://github.com/meshcloud/meshstack-hub/tree/b70efaad7de7fccf2dcb513d94db6308295261a0/modules/stackit/network-area) and
immediately orders one instance of it as the hub address plan, and registers
[`modules/stackit/network`](https://github.com/meshcloud/meshstack-hub/tree/b70efaad7de7fccf2dcb513d94db6308295261a0/modules/stackit/network) so application teams can self-service
